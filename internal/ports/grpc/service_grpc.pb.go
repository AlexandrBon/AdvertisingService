// Code generated by protoc-gen-go-main. DO NOT EDIT.
// versions:
// - protoc-gen-go-main v1.3.0
// - protoc             v4.22.3
...
// is compatible with the main package it is being compiled against.
...
// AdService_ServiceDesc is the main.ServiceDesc for AdService service.
// It's only intended for direct use with main.RegisterService,
